...
return [
    ...
    'Excluded: Posted Player, All Players (Private Battle), Posted Player\'s Team Member (Squad Battle or Splatfest Battle)' => '集計除外: プライベートマッチと、投稿ユーザ、タッグマッチ・フェスマッチ時の投稿者のチームメンバー',
    ...
    'Stats (by Map)' => '統計（マップ別）',
    'Stats (by Mode and Map)' => '統計（マップとルール）',
    ...
    '{0}\'s Battle Stats (by Map)' => '{0}の統計（マップ別）',
    '{0}\'s Battle Stats (by Mode and Map)' => '{0}の統計（マップとルール）',
